...
class ViewFactory {
    ...
    func taskView(isPresented: Binding<Bool>) -> TaskView {
        TaskView(isPresented: isPresented, viewModel: TaskViewModel(taskRepository: self.taskRepository), viewFactory: self)
    }
